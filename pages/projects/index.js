              ...
              >
                <Fade in={openCard1}>
                  <div className={classes.paper}>
                    ...
                    <p id="transition-modal-description-0">
                      {projects[0].describe}
                    </p>
                    <SmallButton name="Source" link={projects[0].linkSource} />
                    {projects[0].linkAction ? (
                      <SmallButton
                        name="Action"
                        link={projects[0].linkAction}
                      />
                    ) : (
                      <></>
                    )}
              ...
              >
                <Fade in={openCard2}>
                  <div className={classes.paper}>
                    ...
                    {projects[1].linkAction ? (
                      <SmallButton
                        name="Action"
                        link={projects[1].linkAction}
                      />
                    ) : (
                      <></>
                    )}{" "}
              ...
              >
                <Fade in={openCard3}>
                  <div className={classes.paper}>
                    ...
                    {projects[2].linkAction ? (
                      <SmallButton
                        name="Action"
                        link={projects[2].linkAction}
                      />
                    ) : (
                      <></>
                    )}{" "}
              ...
              if (i > 2) {
                return (
                  <Othercards
                    ...
                    linkSource={proj.linkSource}
                    linkAction={proj.linkAction}
                  />
                );
              }
            })}
